...
const TravelTruckCard = forwardRef<HTMLLIElement, TravelTruckCardProps>(
  function TravelTruckCard({ travelTruck }, ref) {
    return (
      <li ref={ref} className={css.cardContainer}>
...
export default TravelTruckCard;
